          ...
          {links.map((link, index) => (
            <li key={index}>
              <Link
                ...
                className={`rounded-full px-3.5 py-2.5 font-medium outline-none transition hover:bg-blue-200 hover:text-slate-950 focus:bg-blue-200 ${activeSection === link.name && "bg-blue-200"}`}
              >
                {link.name}
              </Link>
            </li>
