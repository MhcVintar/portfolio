...
export default function ProjectCard({
  ...
  return (
    ...
    >
      <div className="scrollbar-hide flex h-3/5 w-full flex-col overflow-auto px-5 py-4 text-left sm:h-full sm:w-1/2 sm:group-odd:translate-x-[19rem] md:group-odd:translate-x-[21rem] lg:group-odd:translate-x-[22rem]">
