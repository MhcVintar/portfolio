  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden">
        <TimelinePattern className="absolute top-0 left-[22px] z-10 md:left-1/2 md:-translate-x-[10px]" />
          ...
          {educationAndExperience.map((item, index) => (
            ...
            >
              ...
              <TimelineDate
                ...
                className="right-4 mr-4 mb-2 flex items-center gap-x-2 self-end sm:absolute sm:mr-0 md:mb-0 md:self-center md:group-odd:left-1/2 md:group-odd:translate-x-10 md:group-even:right-1/2 md:group-even:-translate-x-10"
              />
              <motion.div
        ...
        <motion.div
          className="absolute top-0 left-[30px] h-full w-[4px] rounded-full bg-amber-300 md:left-1/2 md:-translate-x-1/2"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        />
        <TimelinePattern className="absolute bottom-0 left-[2px] rotate-180 md:right-1/2 md:left-[initial] md:translate-x-[10px]" />
      </div>
    </section>
  );
}
